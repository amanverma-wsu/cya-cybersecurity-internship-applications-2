...
This folder contains evidence of submitted applications.

## Contents

| Screenshot | Description |
|-----------|-------------|
| `jobright-dashboard-98-applied.png` | Jobright AI dashboard showing 98 applied positions with role details, companies, dates, and application status |
